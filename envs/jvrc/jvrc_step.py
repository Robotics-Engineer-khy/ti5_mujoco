...
class JvrcStepEnv(mujoco_env.MujocoEnv):
    def __init__(self):
        ...
        # set goal height
        self.task._goal_height_ref = 0.88
        self.task._total_duration = 1.4
        self.task._swing_duration = 1
        self.task._stance_duration = 0.4
        ...
        append_obs = [(len(base_mir_obs)+i) for i in range(10)]#+2+8
        # y和theta取反
        append_obs[4]=-append_obs[4]
        append_obs[5]=-append_obs[5]
        append_obs[8]=-append_obs[8]
        append_obs[9]=-append_obs[9]
    ...
    def step(self, a):
        ...
        obs = self.get_obs()#相对robot的target脚步规划
    ...
    def reset_model(self):
        ...
        self.init_qpos[root_adr+2] = 0.88
